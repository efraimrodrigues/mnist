...
for r=1:Nr,  % Inicio do loop da simulacao de Monte Carlo 
      ...
      W0=randn(m,n);  % Matriz de pesos inicial (aleatoria)
      W=psrule(W0,Xtrn,Ytrn,Nep,lr);

      Ypred_tst=sign(W*Xtst);    % Predicao da classe dos dados de teste
